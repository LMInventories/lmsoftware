...
def create_user():
    try:
        ...
        user = User(
            ...
            typist_mode=data.get('typist_mode') or None,
        )
        ...
        try:
            from routes.email_notifications import trigger_welcome_user
            trigger_welcome_user(user, plain_password)
        except Exception as email_err:
            print(f'[email] welcome user failed (non-fatal): {email_err}')
