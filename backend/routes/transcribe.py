...
_CHECK_OUT_CONDITION_RULE = (
    'CHECK-OUT CONDITION PREFIX — CRITICAL: when populating a checkOutCondition field '
    '(section_type=room), the value MUST always begin with "As Inventory+\\n" followed by '
    'the condition text. NEVER omit this prefix. '
    'CORRECT:   "As Inventory+\\nScuff to base of door" '
    'INCORRECT: "Scuff to base of door"'
)
